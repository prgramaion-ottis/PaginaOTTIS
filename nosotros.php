    ...
    <div class="container">
        ...
        <div class="nosotros">
            <div class="row row-cols-2 justify-content-end">
                <div class="vehiculos">
                    <img src="./imagenes/nosotros/Mesa_de_trabajo_70.png" height="500px" width="600px" alt="">
                </div>
                <div class="offset-1 col-10 col-sm-10 col-md-4">
        ...
        <div class=""  >
            <img src="./imagenes/nosotros/Mesa_de_trabajo_5.png" alt=""  height="100%" width="100%">
            <!-- <div class="img-cracks col-11 col-md-9 offset-1">
                <img src="./imagenes/nosotros/Mesa_de_trabajo_2.png" alt=""  height="100%">
            </div> -->
        </div>
